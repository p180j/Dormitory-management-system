...
<div class="data_list">
		...
		<form name="myForm" class="form-search" method="post" action="record?action=search" style="padding-bottom: 0px">				
				<span class="data_search">
					...
					&nbsp;<button class="btn btn-success" type="button" style="margin-right: 10px;" onclick="javascript:window.location='record?action=preSave'">添加</button>
				</span>
		</form>
		<div>
