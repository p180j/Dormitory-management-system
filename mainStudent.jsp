...
<div class="container-fluid" >
	<div  style="height: 100px;background-image: url('images/top.jpg')">
		<div align="center" style="width: 80%;height:100px ;float: left;padding-top: 40px;" ><font color="white" size="6" >东华理工大学宿舍管理</font></div>
		<div style="padding-top: 70px;padding-right: 20px;float: right;"><font color="white" size="3" >当前用户：&nbsp;</font><font color="white" >${currentUser.userName }</font></div>
	</div>
</div>
	<div class="container-fluid">
		<div class="row-fluid">
