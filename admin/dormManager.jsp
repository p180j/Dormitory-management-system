...
<div class="data_list">
		...
		<form name="myForm" class="form-search" method="post" action="dormManager?action=search">
				...
				<span class="data_search">
					...
					&nbsp;<button class="btn btn-success" type="button" style="margin-right: 10px;" onclick="javascript:window.location='dormManager?action=preSave'">添加</button> 
				</span>
		</form>
		<div>
