...
<!-- 						<tr>
						<td><input type="button" class="btn  btn-large btn-primary btn-primary" value="提交" onclick="checkForm()" /></td>
						<td><button class="btn  btn-large btn-primary btn-primary" type="button" onclick="javascript:window.location='student'">返回</button></td>
						</tr> -->
					</table>
					<div style="position:relative ; left:44%; " >
						<input type="button" class="btn  btn-large btn-primary btn-primary" value="提交" onclick="checkForm()" />
